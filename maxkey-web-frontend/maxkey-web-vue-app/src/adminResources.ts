...
export const adminResources: AdminResource[] = [
  {
    ...
    fields: [
      ...
      { key: 'employeeNumber', label: '员工编号' }, { key: 'departmentId', label: '部门标识' }, { key: 'department', label: '部门名称' },
      { key: 'userType', label: '用户类型' }, { key: 'jobTitle', label: '职位' }, commonStatus,
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [{ key: 'orgCode', label: '组织编码', required: true }, { key: 'orgName', label: '组织名称', required: true }, { key: 'fullName', label: '组织全称' }, { key: 'parentId', label: '上级组织' }, { key: 'type', label: '类型' }, { key: 'sortIndex', label: '排序', type: 'number' }, commonStatus],
  },
  {
    ...
    fields: [{ key: 'groupCode', label: '用户组编码', required: true }, { key: 'groupName', label: '用户组名称', required: true }, { key: 'category', label: '分类' }, { key: 'description', label: '描述', type: 'textarea' }, commonStatus],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'msadDomain', label: 'AD 域' }, { key: 'description', label: '描述', type: 'textarea' }, commonStatus,
    ],
  },
  { key: 'institutions', title: '机构配置', base: '/config/institutions', singleton: true, columns: [{ key: 'name', label: '名称' }, { key: 'code', label: '编码' }, { key: 'status', label: '状态' }], fields: [{ key: 'name', label: '名称', required: true }, { key: 'code', label: '编码' }, commonStatus] },
  ...
  { key: 'accountsstrategy', title: '账号策略', base: '/config/accountsstrategy', columns: [{ key: 'name', label: '名称' }, { key: 'description', label: '描述' }, { key: 'status', label: '状态' }], fields: [{ key: 'name', label: '名称', required: true }, { key: 'description', label: '描述', type: 'textarea' }, commonStatus] },
  { key: 'socialsprovider', title: '社会化登录', base: '/config/socialsprovider', columns: [{ key: 'provider', label: '提供方' }, { key: 'clientId', label: '客户端标识' }, { key: 'status', label: '状态' }], fields: [{ key: 'provider', label: '提供方', required: true }, { key: 'clientId', label: '客户端标识' }, { key: 'clientSecret', label: '客户端密钥' }, commonStatus] },
  { key: 'ldapcontext', title: 'LDAP 配置', base: '/config/ldapcontext', singleton: true, columns: [{ key: 'providerUrl', label: '地址' }, { key: 'basedn', label: 'Base DN' }, { key: 'status', label: '状态' }], fields: [{ key: 'product', label: '产品类型', type: 'select', required: true, options: [{ label: 'ActiveDirectory', value: 'ActiveDirectory' }, { label: 'OpenLDAP', value: 'OpenLDAP' }, { label: 'StandardLDAP', value: 'StandardLDAP' }] }, { key: 'providerUrl', label: '地址', required: true }, { key: 'basedn', label: 'Base DN' }, { key: 'msadDomain', label: 'AD 域' }, { key: 'principal', label: '账号', required: true }, { key: 'credentials', label: '密码', required: true }, { key: 'filters', label: '过滤条件' }, commonStatus] },
  { key: 'emailsenders', title: '邮件发送器', base: '/config/emailsenders', singleton: true, columns: [{ key: 'name', label: '名称' }, { key: 'host', label: '服务器' }, { key: 'status', label: '状态' }], fields: [{ key: 'name', label: '名称', required: true }, { key: 'host', label: '服务器' }, { key: 'port', label: '端口', type: 'number' }, { key: 'username', label: '账号' }, commonStatus] },
  { key: 'smsprovider', title: '短信服务商', base: '/config/smsprovider', singleton: true, columns: [{ key: 'provider', label: '提供方' }, { key: 'accessKey', label: '访问标识' }, { key: 'status', label: '状态' }], fields: [{ key: 'provider', label: '提供方', required: true }, { key: 'accessKey', label: '访问标识' }, { key: 'secretKey', label: '访问密钥' }, commonStatus] },
  { key: 'passwordpolicy', title: '密码策略', base: '/config/passwordpolicy', singleton: true, columns: [{ key: 'name', label: '名称' }, { key: 'minLength', label: '最小长度' }, { key: 'status', label: '状态' }], fields: [{ key: 'name', label: '名称' }, { key: 'minLength', label: '最小长度', type: 'number' }, { key: 'maxLength', label: '最大长度', type: 'number' }, commonStatus] },
