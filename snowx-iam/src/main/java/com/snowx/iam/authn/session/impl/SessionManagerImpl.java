...
package com.snowx.iam.authn.session.impl;
...
public class SessionManagerImpl implements SessionManager{
    ...
    private void profileLastLogoffTime(String userId, Timestamp lastLogoffTime) {
    ...
    private void sessionLogoff(String sessionId, Timestamp lastLogoffTime) {
    ...
    public void terminate(String sessionId, String userId, String username) {
        Timestamp lastLogoffTime = new Timestamp(System.currentTimeMillis());
            _logger.trace("{} user {} terminate session {} ." ,DateUtils.formatDateTime(lastLogoffTime),username, sessionId);
