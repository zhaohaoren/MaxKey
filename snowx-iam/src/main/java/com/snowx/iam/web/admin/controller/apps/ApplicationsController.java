...
public class ApplicationsController extends BaseAppContorller {
    ...
    public Message<PageResults<Apps>> fetch(@ModelAttribute Apps apps,@CurrentUser UserInfo currentUser) {
        apps.setInstId(currentUser.getInstId());
        PageResults<Apps> appsList =appsService.fetchPageResults(apps);
