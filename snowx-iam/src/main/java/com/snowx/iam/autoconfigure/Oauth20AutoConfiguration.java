...
import com.snowx.iam.authz.oauth2.provider.OAuth2UserDetailsService;
import com.snowx.iam.authz.oauth2.provider.approval.TokenApprovalStore;
import com.snowx.iam.authz.oauth2.provider.approval.endpoint.OAuth20UserApprovalHandler;
import com.snowx.iam.authz.oauth2.provider.client.ClientDetailsUserDetailsService;
import com.snowx.iam.authz.oauth2.provider.client.JdbcClientDetailsService;
import com.snowx.iam.authz.oauth2.provider.code.AuthorizationCodeServices;
import com.snowx.iam.authz.oauth2.provider.code.InMemoryAuthorizationCodeServices;
import com.snowx.iam.authz.oauth2.provider.code.RedisAuthorizationCodeServices;
import com.snowx.iam.authz.oauth2.provider.endpoint.TokenEndpointAuthenticationFilter;
import com.snowx.iam.authz.oauth2.provider.request.DefaultOAuth2RequestFactory;
import com.snowx.iam.authz.oauth2.provider.token.DefaultTokenServices;
import com.snowx.iam.authz.oauth2.provider.token.TokenStore;
import com.snowx.iam.authz.oauth2.provider.token.store.InMemoryTokenStore;
import com.snowx.iam.authz.oauth2.provider.token.store.JwtAccessTokenConverter;
import com.snowx.iam.authz.oauth2.provider.token.store.RedisTokenStore;
import com.snowx.iam.authz.oidc.idtoken.OIDCIdTokenEnhancer;
import com.snowx.iam.configuration.oidc.OIDCProviderMetadataDetails;
import com.snowx.iam.constants.ConstsPersistence;
import com.snowx.iam.crypto.jose.keystore.JWKSetKeyStore;
import com.snowx.iam.crypto.jwt.encryption.service.impl.DefaultJwtEncryptionAndDecryptionService;
import com.snowx.iam.crypto.jwt.signer.service.impl.DefaultJwtSigningAndValidationService;
...
@ComponentScan(basePackages = {
        "com.snowx.iam.authz.oauth2.provider.endpoint",
        "com.snowx.iam.authz.oauth2.provider.userinfo.endpoint",
        "com.snowx.iam.authz.oauth2.provider.approval.controller",
        "com.snowx.iam.authz.oauth2.provider.wellknown.endpoint"
})
