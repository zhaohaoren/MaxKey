...
import com.snowx.iam.persistence.mapper.InstitutionsMapper;
...
@Repository
public class InstitutionsServiceImpl  extends SnowxServiceImpl<InstitutionsMapper,Institutions,String> implements InstitutionsService{
