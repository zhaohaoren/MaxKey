...
import com.snowx.iam.persistence.mapper.OrganizationsMapper;
...
@Repository
public class OrganizationsServiceImpl  extends SnowxServiceImpl<OrganizationsMapper,Organizations,String> implements OrganizationsService{
    static final Logger _logger = LoggerFactory.getLogger(OrganizationsServiceImpl.class);
     ...
     @Override
     public boolean saveOrUpdate(Organizations organization) {
