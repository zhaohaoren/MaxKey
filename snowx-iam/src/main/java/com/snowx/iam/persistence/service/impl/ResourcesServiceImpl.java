...
import com.snowx.iam.persistence.mapper.ResourcesMapper;
...
@Repository
public class ResourcesServiceImpl  extends SnowxServiceImpl<ResourcesMapper,Resources,String> implements ResourcesService{
    
    @Override
    public List<Resources> queryResourcesTree(Resources resource){
       return super.query(resource);
    }
}
