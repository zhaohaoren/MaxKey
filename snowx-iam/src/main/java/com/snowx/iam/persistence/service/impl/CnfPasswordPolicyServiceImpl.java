...
import com.snowx.iam.constants.ConstsProperties;
import com.snowx.iam.entity.cnf.CnfPasswordPolicy;
import com.snowx.iam.persistence.mapper.CnfPasswordPolicyMapper;
...
@Repository
public class CnfPasswordPolicyServiceImpl  extends SnowxServiceImpl<CnfPasswordPolicyMapper,CnfPasswordPolicy,String> implements CnfPasswordPolicyService{
    ...
    public CnfPasswordPolicy getPasswordPolicy() {
        ...
        if (passwordPolicy == null) {
            LambdaQueryWrapper<CnfPasswordPolicy>query = new LambdaQueryWrapper<>();
            query.isNotNull(CnfPasswordPolicy::getId);
