 ...
 * @author MaxKey Team
 */
public interface UserPasskeyMapper extends SnowxMapper<UserPasskey,String> {
     ...
     * @return 删除的记录数
     */
    @Delete("DELETE FROM mxk_user_passkeys WHERE status = 0 AND created_date < (CURRENT_TIMESTAMP - INTERVAL '30 day')")
