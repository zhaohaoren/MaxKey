...
import com.snowx.iam.persistence.mapper.ConnectorsMapper;
...
@Repository
public class ConnectorsServiceImpl  extends SnowxServiceImpl<ConnectorsMapper,Connectors,String> implements ConnectorsService{
