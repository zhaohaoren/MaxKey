...
import com.snowx.iam.persistence.mapper.PermissionRoleMapper;
...
@Repository
public class PermissionRoleServiceImpl  extends SnowxServiceImpl<PermissionRoleMapper,PermissionRole,String> implements PermissionRoleService{
