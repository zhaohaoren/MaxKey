...
import com.snowx.iam.persistence.mapper.UserPasskeyMapper;
...
@Repository
@Transactional
public class UserPasskeyServiceImpl extends SnowxServiceImpl<UserPasskeyMapper, UserPasskey,String> implements UserPasskeyService {
