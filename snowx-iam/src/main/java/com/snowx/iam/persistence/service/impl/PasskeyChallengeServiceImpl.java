...
import com.snowx.iam.entity.passkey.PasskeyChallenge;
import com.snowx.iam.persistence.mapper.PasskeyChallengeMapper;
import com.snowx.iam.persistence.service.PasskeyChallengeService;
...
@Repository
@Transactional
public class PasskeyChallengeServiceImpl extends SnowxServiceImpl<PasskeyChallengeMapper, PasskeyChallenge,String> implements PasskeyChallengeService {
