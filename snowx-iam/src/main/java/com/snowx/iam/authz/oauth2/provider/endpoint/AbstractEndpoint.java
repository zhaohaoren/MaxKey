...
import com.snowx.iam.authz.oauth2.provider.CompositeTokenGranter;
import com.snowx.iam.authz.oauth2.provider.OAuth2RequestFactory;
import com.snowx.iam.authz.oauth2.provider.TokenGranter;
import com.snowx.iam.authz.oauth2.provider.client.ClientCredentialsTokenGranter;
import com.snowx.iam.authz.oauth2.provider.code.AuthorizationCodeServices;
import com.snowx.iam.authz.oauth2.provider.code.AuthorizationCodeTokenGranter;
import com.snowx.iam.authz.oauth2.provider.code.InMemoryAuthorizationCodeServices;
import com.snowx.iam.authz.oauth2.provider.implicit.ImplicitTokenGranter;
import com.snowx.iam.authz.oauth2.provider.password.ResourceOwnerPasswordTokenGranter;
import com.snowx.iam.authz.oauth2.provider.refresh.RefreshTokenGranter;
import com.snowx.iam.authz.oauth2.provider.request.DefaultOAuth2RequestFactory;
import com.snowx.iam.authz.oauth2.provider.token.AuthorizationServerTokenServices;
