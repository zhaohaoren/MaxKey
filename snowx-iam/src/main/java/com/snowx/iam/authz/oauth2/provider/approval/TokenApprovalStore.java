...
package com.snowx.iam.authz.oauth2.provider.approval;
...
import com.snowx.iam.authz.oauth2.provider.approval.Approval.ApprovalStatus;
...
public class TokenApprovalStore implements ApprovalStore {
     ...
     * 
     * @see com.snowx.iam.authz.oauth2.provider.approval.ApprovalStore#addApprovals(java.util.Collection)
     */
    @Override
     ...
     * 
     * @see com.snowx.iam.authz.oauth2.provider.approval.ApprovalStore#revokeApprovals(java.util.Collection)
     */
    @Override
     ...
     * 
     * @see com.snowx.iam.authz.oauth2.provider.approval.ApprovalStore#getApprovals(java.lang.String,
     * java.lang.String)
     */
    @Override
