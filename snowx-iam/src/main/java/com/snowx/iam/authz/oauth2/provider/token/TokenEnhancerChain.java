...
public class TokenEnhancerChain implements TokenEnhancer {
     ...
     * 
     * @see com.snowx.iam.authz.oauth2.provider.token.TokenEnhancer#enhance(com.snowx.iam.authz.oauth2.common.OAuth2AccessToken,
     * com.snowx.iam.authz.oauth2.provider.OAuth2Authentication)
     */
    @Override
