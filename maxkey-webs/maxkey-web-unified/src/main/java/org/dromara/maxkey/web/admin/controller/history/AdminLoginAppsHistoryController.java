...
package org.dromara.maxkey.web.admin.controller.history;
...
public class AdminLoginAppsHistoryController {
    static final Logger logger = LoggerFactory.getLogger(AdminLoginAppsHistoryController.class);
